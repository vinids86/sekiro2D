...
var transitions: Dictionary = {
	...
	CombatTypes.CombatState.STARTUP:          [CombatTypes.CombatState.ATTACKING, CombatTypes.CombatState.PARRY_ACTIVE, CombatTypes.CombatState.STUNNED, CombatTypes.CombatState.RECOVERING_HARD, CombatTypes.CombatState.GUARD_BROKEN],
	CombatTypes.CombatState.ATTACKING:        [CombatTypes.CombatState.RECOVERING_HARD, CombatTypes.CombatState.STUNNED, CombatTypes.CombatState.PARRY_ACTIVE, CombatTypes.CombatState.GUARD_BROKEN],
	CombatTypes.CombatState.RECOVERING_HARD:  [CombatTypes.CombatState.RECOVERING_SOFT],
	CombatTypes.CombatState.RECOVERING_SOFT:  [CombatTypes.CombatState.IDLE, CombatTypes.CombatState.STARTUP],
	CombatTypes.CombatState.PARRY_ACTIVE:     [CombatTypes.CombatState.PARRY_SUCCESS, CombatTypes.CombatState.IDLE, CombatTypes.CombatState.STUNNED, CombatTypes.CombatState.RECOVERING_HARD, CombatTypes.CombatState.GUARD_BROKEN],
	...
	CombatTypes.CombatState.GUARD_BROKEN:     [CombatTypes.CombatState.IDLE, CombatTypes.CombatState.RECOVERING_HARD],
